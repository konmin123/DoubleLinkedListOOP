...
class TestDoubleLinkedList(unittest.TestCase):
    ...
    def test_init_with_data(self):
        ...
        self.assertEqual("Dln(1, None, Dln(2))", repr(ll._head))
        self.assertEqual("Dln(3, Dln(2), None)", repr(ll._tail))
    ...
    def test_setitem(self):
        ...
        ll = DoubleLinkedList([1, 2, 3])
        DoubleLinkedList.__setitem__(ll, 1, '80')
    ...
    def test_del_head_node(self):
        ...
        self.assertEqual(2, ll._len, msg="Неправильная длина результирующего списка")
